# 📖 Personalized AI Tutor for Indian Local Languages

> Curriculum tutor handling regional accents. Sends study milestones to Telegram parent channels.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/regional-accent-tutor/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-regional-accent-tutor.git
cd tp-regional-accent-tutor
```
...
```bash
kubectl port-forward deployment/tp-regional-accent-tutor 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── vernacular_tutor.py     # Main configuration file
```
...
---
*Generated by [Personalized AI Tutor for Indian Local Languages Studio](https://pradeeptalari14.github.io/portfolio/tools/regional-accent-tutor/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
